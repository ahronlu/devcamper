...
export const REVIEW_CREATE_REVIEW_REQUEST = "REVIEW_CREATE_REVIEW_REQUEST";
export const REVIEW_CREATE_REVIEW_SUCCESS = "REVIEW_CREATE_REVIEW_SUCCESS";
export const REVIEW_CREATE_REVIEW_FAIL = "REVIEW_CREATE_REVIEW_FAIL";
export const REVIEW_CREATE_REVIEW_RESET = "REVIEW_CREATE_REVIEW_RESET";
